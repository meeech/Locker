...
util.expandLink({url:"http://google.com/"},console.log,console.log);
util.extractFavicon({url:"http://google.com/foo",},console.log,console.log);
util.extractLinks({text:"hey http://google.com/ can you find bar.com or (bit.ly/foo)?"},console.log,console.log);
